...
public class GithubScreen {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final String resetRepositoryCommand = GithubService.INSTANCE.getResetRepositoryCommand("https://github.com/magistermagus/screen-slave");
        ...
        IOUtils.write("git config user.email 'magistermagus@web.de'; git config user.name 'magistermagus'; ", outStream);
